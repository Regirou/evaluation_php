...
if(isset($_GET['id_produit'])){
    ...
    if($resultat->rowCount()<=0){
       ...
       echo "<p>Arrivée: $produit[date_arrivee] "; echo date('H:i',strtotime($produit['heure_arrivee']));
       echo "</p>";
       echo "<p>Départ: $produit[date_depart] "; echo date('H:i',strtotime($produit['heure_depart']));
       echo "</p>";
